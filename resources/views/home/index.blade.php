...
@section('content')
    ...
    <div class="index-wrapper">
                ...
                <div class="row">
                    <div class="col-xs-4">
                        <div class="service-single">
                            <img src="https://flavorgod.s3.amazonaws.com/homepage/icon-shipping.png" alt="" />
                            <h3>
                    ...
                    <div class="col-xs-4">
                        <div class="service-single">
                            <img src="https://flavorgod.s3.amazonaws.com/homepage/icon-free.png" alt="" />
                            <h3>
                    ...
                    <div class="col-xs-4">
                        <div class="service-single">
                            <img src="https://flavorgod.s3.amazonaws.com/homepage/icon-support.png" alt="" />
                            <h3>
        ...
        <!--Product section coding start here-->
         <div class="sec-product old-section">
            <div class="container store-details">
               ...
               {{--  foreach starts here --}}
                @foreach($products as $product)
                    <li class="col-sm-6 col-md-4 col-lg-3 product-set" data-category-set="{{ implode(' ', @$product['product_sets']['category'] ?: []) }}" data-flags-set="{{ implode(' ', @$product['product_sets']['flags'] ?: []) }}" style="display:none">
        ...
        <!--New Product section coding start here-->
        <div class="sec-product new-section">
            <div class="container store-details">
                <div class="mobile-dropdown-search visible-xs">
                    <form action="/shop" class="input-group">
                        <input placeholder="Looking for…" class="form-control" name="search">
                ...
                <div class="sec-product-filter">
                    <div class="dropdown-nav-holder">
                        <span class="text-box">Filter By</span>
                        <a href="#" class="opener">
                        ...
                        <ul class="nav" style="display: none;">
                          @foreach($productSets as $set)
                          <li role="presentation" @if($set['slug']!='all') data-filter="#{{ $set['slug'] }}" class="active" @else data-filter="#" @endif style="display:none"><a href="#{{ $set['slug'] }}-new">{{ $set['name'] }}</a></li>
                          @endforeach
                ...
                <div class="product-slider-main-holder">
                    ...
                    <div class="product-slide-box">
                        <div id="{{ $productSet['slug'] }}-new" class="header">
                                ...
                                <li class="product-set" data-category-set="{{ implode(' ', @$product['product_sets']['category'] ?: []) }}">
                                    ...
                                    <div class="prod-single prod-red">
                                        <a href="/shop/{{ !empty($product['slug'])? 'product/'.$product['slug'].'/#'.$product['base_variant']['sku']: 'product/'.$product['id']}}" class="prod-img" title="{{ $product['base_variant']['name'] }}">
                                            <div class="dis-table">
                                                <div class="dis-table-cell">
                                                    <img class="lazy img-responsive" src="https://placeholdit.imgix.net/~text?bg=ffffff&w=263&h=263" data-original="{{ $renderer->assetExists($product['base_variant']['assets'], 'primary_image', 'image') }}" alt="{{ @$product['base_variant']['name'] }}" title="{{ @$product['base_variant']['name'] }}" />
                                                    <div class="prod-overlay">
                                                        <div class="dis-table">
                                                            <div class="dis-table-cell">
                                                                <p>
                                                                    <img src="https://flavorgod.s3.amazonaws.com/homepage/prod-hover.png" alt="click to Learn More" title="click to Learn More" />
                                                                    <span>click to Learn More</span>
                                                                </p>
                                                            </div>
                                                        </div>
        ...
        <!--New Product section coding ends here-->
        ...
        <div class="sec-learn hidden-xs">
            ...
            <div class="side-img side-left">
                <img src="https://flavorgod.s3.amazonaws.com/homepage/img-learn-left.png" alt="" />
            </div>
            <div class="side-img side-right">
                <img src="https://flavorgod.s3.amazonaws.com/homepage/img-learn-right.png" alt="" />
            </div>
        </div>
        <!--Learn section coding starts here-->
...
(function (window, undefined){
    ...
    function filterProducts(filter, animate) {
        var $active;
        var $removed;
        if($(".new-section:visible").length>0){
            filter = filter.replace("-new", "")
        }
    ...
    function initOwlSlider() {
        ...
        if ($('.main-product-slider').length > 0) {
            $('.main-product-slider').owlCarousel({
                ...
                lazyLoadForContainer(".product-slide-box");
    ...
    function lazyLoadForContainer(selector){
        $("img.lazy").lazyload({
            container: $(selector),
        });
    ...
    $(document).ready(function() {
        ...
        if($(".new-section:visible").length>0){
            initLazyLoading(".main-product-slider");
        } else{
            initLazyLoading(".old-section");
        }
