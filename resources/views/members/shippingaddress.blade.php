        ...
        <div class="profile-links">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><a href="#">Edit Shipping Address</a></li>
                </ol>
			                    ...
			                    <li>
			                       ...
			                       <div class="item-links">
			                       		...
			                       		@else
			                       			<span>
			                       				@if($currentUser->addresses->count() > 1)
				                               		<a href="/members/address/{{ $address->id }}/shipping/default">Make Default</a> &nbsp; <a href="/members/address/{{ $address->id }}/edit">Edit</a> &nbsp;  <a href="/members/address/{{ $address->id }}/delete">Delete</a> 
			                       				@else
					                               <a href="/members/address/{{ $address->id }}/shipping/default">Make Default</a> &nbsp; <a href="/members/address/{{ $address->id }}/edit">Edit</a>
			                       				@endif
				                           </span>
			                       		@endif
			                       </div>
